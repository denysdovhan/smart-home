 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,r=null)=>{for(;e!==r;){const r=e.nextSibling;t.removeChild(e),e=r}},r=`{{lit-${String(Math.random()).slice(2)}}}`,s=`\x3c!--${r}--\x3e`,n=new RegExp(`${r}|${s}`);class i{constructor(t,e){this.parts=[],this.element=e;const s=[],i=[],o=document.createTreeWalker(e.content,133,null,!1);let p=0,d=-1,u=0;const{strings:h,values:{length:m}}=t;for(;u<m;){const t=o.nextNode();if(null!==t){if(d++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:r}=e;let s=0;for(let t=0;t<r;t++)a(e[t].name,"$lit$")&&s++;for(;s-- >0;){const e=h[u],r=c.exec(e)[2],s=r.toLowerCase()+"$lit$",i=t.getAttribute(s);t.removeAttribute(s);const a=i.split(n);this.parts.push({type:"attribute",index:d,name:r,strings:a}),u+=a.length-1}}"TEMPLATE"===t.tagName&&(i.push(t),o.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(r)>=0){const r=t.parentNode,i=e.split(n),o=i.length-1;for(let e=0;e<o;e++){let s,n=i[e];if(""===n)s=l();else{const t=c.exec(n);null!==t&&a(t[2],"$lit$")&&(n=n.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),s=document.createTextNode(n)}r.insertBefore(s,t),this.parts.push({type:"node",index:++d})}""===i[o]?(r.insertBefore(l(),t),s.push(t)):t.data=i[o],u+=o}}else if(8===t.nodeType)if(t.data===r){const e=t.parentNode;null!==t.previousSibling&&d!==p||(d++,e.insertBefore(l(),t)),p=d,this.parts.push({type:"node",index:d}),null===t.nextSibling?t.data="":(s.push(t),d--),u++}else{let e=-1;for(;-1!==(e=t.data.indexOf(r,e+1));)this.parts.push({type:"node",index:-1}),u++}}else o.currentNode=i.pop()}for(const t of s)t.parentNode.removeChild(t)}}const a=(t,e)=>{const r=t.length-e.length;return r>=0&&t.slice(r)===e},o=t=>-1!==t.index,l=()=>document.createComment(""),c=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function p(t,e){const{element:{content:r},parts:s}=t,n=document.createTreeWalker(r,133,null,!1);let i=u(s),a=s[i],o=-1,l=0;const c=[];let p=null;for(;n.nextNode();){o++;const t=n.currentNode;for(t.previousSibling===p&&(p=null),e.has(t)&&(c.push(t),null===p&&(p=t)),null!==p&&l++;void 0!==a&&a.index===o;)a.index=null!==p?-1:a.index-l,i=u(s,i),a=s[i]}c.forEach(t=>t.parentNode.removeChild(t))}const d=t=>{let e=11===t.nodeType?0:1;const r=document.createTreeWalker(t,133,null,!1);for(;r.nextNode();)e++;return e},u=(t,e=-1)=>{for(let r=e+1;r<t.length;r++){const e=t[r];if(o(e))return r}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,r,s){const n=e[0];if("."===n){return new O(t,e.slice(1),r).parts}return"@"===n?[new T(t,e.slice(1),s.eventContext)]:"?"===n?[new R(t,e.slice(1),r)]:new k(t,e,r).parts}handleTextExpression(t){return new V(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;const bt="data:image/png;base64,";customElements.define("vacuum-card",class extends B{static get properties(){return{hass:Object,config:Object,mapUrl:String,requestInProgress:Boolean}}static get styles(){return vt}static async getConfigElement(){return document.createElement("vacuum-card-editor")}static getStubConfig(t,e){const[r]=e.filter(t=>"vacuum"===t.substr(0,t.indexOf(".")));return{entity:r||"",image:"default"}}get entity(){return this.hass.states[this.config.entity]}get map(){return this.hass.states[this.config.map]}get image(){return"default"===this.config.image?bt:this.config.image||bt}setConfig(t){if(!t.entity)throw new Error("Specifying entity is required!");this.config=t}getCardSize(){return 2}shouldUpdate(t){return function(t,e,r){if(e.has("config")||r)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t)}updated(t){if(this.map){const t=this.map.attributes.entity_picture+"&t="+(new Date).getTime(),e=new Image;e.onload=()=>{this.mapUrl=t},e.src=t}t.get("hass")&&t.get("hass").states[this.config.entity].state!==this.hass.states[this.config.entity].state&&(this.requestInProgress=!1)}handleMore(){St(this,"hass-more-info",{entityId:this.entity.entity_id},{bubbles:!0,composed:!0})}handleSpeed(t){const e=t.target.getAttribute("value");this.callService("set_fan_speed",{fan_speed:e})}callService(t,e={}){this.hass.callService("vacuum",t,{entity_id:this.config.entity,...e}),this.requestInProgress=!0,this.requestUpdate()}getAttributes(t){const{status:e,fan_speed:r,fan_speed_list:s,battery_level:n,battery_icon:i,cleaned_area:a,cleaning_time:o,main_brush_left:l,side_brush_left:c,filter_left:p,sensor_dirty_left:d,currentCleanTime:u,currentCleanArea:h,cleanArea:m,cleanTime:f,mainBrush:g,sideBrush:y,filter:S,sensor:v,valetudo_state:b}=t.attributes;return{status:e||b.name,fan_speed:r,fan_speed_list:s,battery_level:n,battery_icon:i,cleaned_area:a||h||m,cleaning_time:o||u||f,main_brush_left:l||g,side_brush_left:c||y,filter_left:p||S,sensor_dirty_left:d||v}}renderSource(){const{fan_speed:t,fan_speed_list:e}=this.getAttributes(this.entity);if(!e)return E``;const r=e.indexOf(t);return E` <paper-menu-button
    ...
    >
      ...
      >
        ...
        `}}renderToolbar(t){switch(t){case"cleaning":return E`
          <div class="toolbar">
